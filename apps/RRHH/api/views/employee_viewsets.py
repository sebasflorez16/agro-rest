...
class EmployeeViewSet(ModelViewSet):
    ...
    def destroy(self, request, pk=None, *args, **kwargs):
        ...
        return Response({'message': 'El empleado no ha sido encontrado o ya esta desactivado'},
...
class TemporaryViewSet(viewsets.ModelViewSet):
    ...
    def update(self, request, pk=None, *args, **kwargs):
        if self.get_queryset(pk):
            ...
            if temporary_serializer.is_valid():
                ...
                return Response({'message': 'Registro actualizado', 'data': temporary_serializer.data},
    ...
    def create(self, request, *args, **kwargs):
        ...
        return Response({"message": "Empleado temporal creado correctamente"}, status=status.HTTP_201_CREATED,
                        headers=headers)

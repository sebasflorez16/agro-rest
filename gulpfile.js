...
const app = "/Users/sebastianflorez/Documents/Archivos Progra/agro rest/Agro Tech/agro-rest/assets";
...
const paths = {
  ...
  src: {
    css: {
      dir: app + "/source/css",
      files: app + "/source/css/**/*",
    },
    images: {
      dir: app + "/source/images",
      files: app + "/source/images/**/*",
    },
    fonts: {
      dir: app + "/source/fonts",
      files: app + "/source/fonts/**/*",
    },
    js: {
      dir: app + "/source/js",
      pages: app + "/source/js/pages",
      files: app + "/source/js/pages/*.js",
      main: app + "/source/js/*.js",
    },
    scss: {
      dir: app + "/source/scss",
      files: app + "/source/scss/**/*",
      icons: app + "/source/scss/icons.scss",
      main: app + "/source/scss/app*.scss",
      bootstrap: app + "/source/scss/bootstrap*.scss",
    },
  },
};
